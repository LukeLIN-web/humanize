...
- `## Codex Team Workflow`
- `## Convergence Log`
- `--- Design Requirements (from conversation) Start ---` appendix (legacy, from plans generated before gen-plan stopped appending it) and its matching end marker
